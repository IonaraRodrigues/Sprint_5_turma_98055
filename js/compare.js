...
class Car {
    constructor(nome, preco, alturaCacamba, alturaVeiculo, alturaSolo, capacidadeCarga, motor, potencia, volumeCacamba, roda, image){
        this.nome = nome;
        this.preco = preco;
        this.alturacaCacamba = alturaCacamba;
...
function UpdateCompareTable() {
   ...
   for(let i = 0; i < carArr.lenght; i++) {
       ...
       document.getElementById(`compare_capacidadedecarga_${i}`).textContent = car.capacidadedeCarga;
       ...
       document.getAnimations(`compare_preco_${i}`).textContent = `R$ ${car.preco.toLocaleString('pt-BR')}`;
   } 
}
